...
const TransactionsTable = ({ data }: Props) => {
  ...
  return (
    <div className="w-full overflow-x-auto rounded-lg border-2 borde-gray-950">
      <table className="w-full table-auto">
        <thead className="bg-gray-950 text-white sticky">
          <tr>
        ...
        <tbody>
          {data?.map((transaction) => {
            ...
            return (
              ...
              >
                <td className={`${tableColumnPadding} grid grid-cols-3 gap-2`}>
                  <Link
                ...
                <td
                  className={`${tableColumnPadding} font-bold ${
